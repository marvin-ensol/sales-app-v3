-- 1. Add hs_membership_id column to task_automation_runs for better debugging
ALTER TABLE task_automation_runs 
ADD COLUMN IF NOT EXISTS hs_membership_id uuid;

-- 2. Update handle_list_membership_automation to send trigger_type = 'list_entry' and store membership_id
