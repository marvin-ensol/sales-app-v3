-- Update get_owner_tasks function to dynamically map null queue memberships to fallback category
...
-- Update get_all_tasks function to dynamically map null queue memberships to fallback category
