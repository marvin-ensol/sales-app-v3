-- Drop and recreate the get_enriched_events function with updated documentation
-- Note: The function logic remains the same, but this ensures compatibility with the new field names
-- The filter conditions still use total_update_successful and total_update_unsuccessful which are unchanged
