-- Drop existing get_task_categories functions
DROP FUNCTION IF EXISTS public.get_task_categories(text);
DROP FUNCTION IF EXISTS public.get_task_categories();

-- Recreate get_task_categories function with team_id parameter including locks_lower_categories
...
-- Recreate get_task_categories function without parameters including locks_lower_categories
