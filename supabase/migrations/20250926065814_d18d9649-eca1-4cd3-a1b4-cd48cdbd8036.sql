-- Fix task category visibility logic
-- Update the get_task_categories function to correctly handle visibility
-- Empty array [] should mean "visible to no one"
-- NULL should mean "visible to everyone"
