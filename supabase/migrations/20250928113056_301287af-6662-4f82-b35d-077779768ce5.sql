-- Update the get_all_tasks function to use dynamic category mapping
...
-- Update the get_owner_tasks function to use dynamic category mapping
...
BEGIN
    ...
    SELECT id::text INTO new_queue_id 
