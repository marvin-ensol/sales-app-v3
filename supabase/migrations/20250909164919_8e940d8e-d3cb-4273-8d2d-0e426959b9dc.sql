...
CREATE INDEX IF NOT EXISTS idx_hs_tasks_owner_id ON hs_tasks(hubspot_owner_id);
CREATE INDEX IF NOT EXISTS idx_hs_tasks_status ON hs_tasks(hs_task_status);
CREATE INDEX IF NOT EXISTS idx_hs_tasks_queues ON hs_tasks USING GIN(string_to_array(hs_queue_membership_ids, ';'));
CREATE INDEX IF NOT EXISTS idx_hs_tasks_associated_contact ON hs_tasks(associated_contact_id);
CREATE INDEX IF NOT EXISTS idx_hs_tasks_completion_date ON hs_tasks(hs_task_completion_date);
CREATE INDEX IF NOT EXISTS idx_hs_tasks_timestamp ON hs_tasks(hs_timestamp);
CREATE INDEX IF NOT EXISTS idx_hs_contacts_object_id ON hs_contacts(hs_object_id);
CREATE INDEX IF NOT EXISTS idx_hs_users_owner_id ON hs_users(owner_id);
CREATE INDEX IF NOT EXISTS idx_hs_users_archived ON hs_users(archived);

-- Create enriched tasks view with all necessary joins and transformations
...
-- Function to get valid team member IDs (replicating the team filtering logic)
...
-- Function to get enriched tasks for a specific owner
...
-- Function to get all tasks for dashboard (no owner filter)
