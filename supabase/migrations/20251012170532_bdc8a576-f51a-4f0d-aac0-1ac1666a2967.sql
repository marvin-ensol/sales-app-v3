-- Restore original handle_list_membership_automation function (per-contact trigger pattern)
-- This removes the first_task_creation check that was preventing individual task_automation_runs creation
...
DROP TRIGGER IF EXISTS handle_list_membership_automation_trigger ON hs_list_memberships;

CREATE TRIGGER handle_list_membership_automation_trigger
