-- Drop the existing function and recreate it with hubspot_owner_id
DROP FUNCTION public.get_owner_tasks(text);

-- Recreate the function with hubspot_owner_id in the return signature
