-- Fix deleted task handling in get_owner_tasks and get_all_tasks functions
-- Add explicit mapping for DELETED status to prevent deleted tasks from appearing in the UI

-- Update get_owner_tasks function
    ...
    enriched_data AS (
        SELECT 
            ...
            CASE 
                ...
                WHEN tcm.hs_task_status = 'DELETED' THEN 'deleted'
                ELSE 'not_started'
            END as status,
            CASE 
